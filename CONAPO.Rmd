...
<!-- Pregunta: Desafios del actuario -->
...
.right-column[
  .center[
    <span class="large-text" style="position: absolute; bottom: 150px; left: 350px; text-align: center;">Puedes leer el lenguaje matemático </span>
  ]
]
...
```{r, out.height='80%', out.extra='100%', out.width='90%'}
require(knitr)
knitr::include_graphics("img/Principal-Component-Analysis- I.T. Jollife-2ed-Springer-2002 36.pdf",
                        dpi = 400
                        )
```
...
<span class="large-text"; style="top: 450px; left: 400px; color: #D56A2E; font-size: 3.5em; text-align: center;">
...
ggplot(data = cars, aes(x = dist)) +
  geom_histogram(aes(y = ..density.., fill = ..count.., color = ..count..), bins = 30, alpha = 0.7) +
...
.pull-right[
```{r, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE, fig.height=5}
require(ggplot2) 
...
.right-column[
  .bottom[
    <img src="img/Firma Diana Villasana Ocampo.gif" style="position: absolute; bottom: 10px; right: 10px; width: 700px; height: 200px;">
    </span>
  ]
]
